...
Scratch Addons est un projet d’équipe dirigé par World_Languages. Vous pouvez trouver la liste des personnes qui ont contribué à nous sur [la page Crédits](/credits). Alors que les addons "Scratch Messaging" et "Developer tools" ont été initialement créés par griffpatch, il ne maintient pas l’extension.
...
Pour les utilisateurs d’Android : Oui, mais il n’est pas recommandé. Les principaux navigateurs ne permettent pas l’installation de Scratch Addons (ou d’autres extensions), vous devez donc utiliser des navigateurs comme [Kiwi] (https://kiwibrowser.com/) pour ce faire. L’interface utilisateur de Scratch Addons n’est pas bien testée sur les écrans tactiles ou les environnements de petite taille, donc certaines fonctionnalités pourraient ne pas fonctionner comme prévu.

Pour les utilisateurs d’iOS et iPadOS : Malheureusement, ce n’est pas possible. La politique App Store ne permet pas de télécharger les implémentations de navigateur, ce qui signifie que tous les navigateurs disponibles sur cette plate-forme sont simplement re-kinned Safari. Cela pose certains problèmes (voir ci-dessous).
...
Comme alternative, la plupart des modules complémentaires de l'éditeur de projet sont disponibles sur [TurboWarp](https://turbowarp.org/) qui a une [application téléchargeable](https://desktop.turbowarp.org/) pour Windows, macOS, et Linux. De plus, sur les navigateurs prenant en charge les applications Web progressives (PWA) telles que Google Chrome, vous pouvez également installer l'éditeur TurboWarp en tant que PWA et l'utiliser sans connexion Internet.
...
Si vous trouvez une faille de sécurité, veuillez contacter World_Languages en privé en envoyant un courriel à `worldxlanguages@gmail.com`. Si vous n’obtenez pas de réponse dans les 48 heures, veuillez [créer un problème] (https://github.com/ScratchAddons/ScratchAddons/issues/) en mentionnant que vous avez envoyé un courriel.

Vous pouvez soit [lire notre politique de sécurité](https://github.com/ScratchAddons/ScratchAddons/security/policy) ou [consulter nos avis que nous avons publiés](https://github.com/ScratchAddons/ScratchAddons/security/advisories?state=published).
...
Nous n'envoyons jamais d'informations confidentielles ou d'identification personnelle en dehors de votre navigateur. Voir [la politique de confidentialité de l'extension](/docs/privacy/policies/extension) pour plus d'informations.
...
- ouvrir la fenêtre contextuelle et cliquer sur l’icône d’engrenage dans le coin supérieur droit
- aller à https://scratch.mit.edu/scratch-addons-extension/settings. Remarque : vous devez avoir l’extension installée pour que ce lien fonctionne.
...
- Windows : Ouvrez les paramètres, ouvrez la catégorie "Notifications & actions", puis trouvez "Modifier les paramètres de notification pour les expéditeurs individuels". Consultez [l’article d’aide de Microsoft] (https://support.microsoft.com/en-us/windows/change-notification-settings-in-windows-8942c744-6198-fe56-4639-34320cf9444f) pour obtenir de plus amples renseignements.
- macOS : Ouvrez Préférences Système, puis ouvrez la section Notifications. Sélectionnez le navigateur (par ex. Google Chrome) sur la gauche et activer les notifications. Consultez [l’article d’aide d’Apple] (https://support.apple.com/en-us/HT204079) pour obtenir de plus amples renseignements.
...
En raison de contraintes techniques, les vidéos enregistrées avec ce module sont en format WebM. Vous pouvez voir . webm fichiers en utilisant votre navigateur (en faisant glisser et en déposant le fichier) ou en utilisant un lecteur multimédia qui le supporte, comme [VLC Media Player](https://www.videolan.org/).

Pour convertir des fichiers WebM en MP4 ou dans d’autres formats, vous pouvez utiliser un logiciel de conversion vidéo qui prend en charge WebM, comme [HandBrake](https://handbrake.fr/) ou [CloudConvert](https://cloudconvert.com/webm-)to-mp4), bien que nous recommandons simplement de visualiser ces fichiers avec un navigateur ou un lecteur multimédia. Notez que cela peut prendre beaucoup de temps selon la taille de la vidéo.
...
Certains de nos ajouts easter egg sont "Fixer la capitalisation des paramètres de compte" et "Glitch de point-virgule". Consultez [l’onglet addons](/addons) pour une liste complète.
...
- **Contribuez du code**
  ...
  Pour intégrer vos modifications dans l’extension principale, vous devez créer une requête de tirage. Vous pouvez le faire en forçant [le dépôt](https://github.com/ScratchAddons/ScratchAddons/), en créant une branche, en apportant les modifications nécessaires, puis en trouvant l’option de créer une requête de tirage. Nous allons l’examiner et probablement y apporter des changements avant qu’il ne soit fusionné.

  Vous pouvez également contribuer à d'autres aspects de l'organisation, comme notre site Web. Vous pouvez voir tous nos référentiels sur [notre page d'organisation GitHub](https://github.com/ScratchAddons).

- **Suggérer une idée** 

  vez-vous une idée qui, selon vous, serait un bon ajout à Scratch Addons? [Faites-nous savoir! ](#i-think-you-missed-a-feature-what-can-i-do)

- **Rapporter un bug**

  Vous avez trouvé un bogue dans l’un de nos addons, la page des paramètres ou autre chose dans notre extension ? [Envoyez-nous un rapport de bogue](#what-can-i-do-if-i-find-a-problem).

- **Traduire Scratch Addons**

  Si vous parlez couramment une autre langue, vous pouvez aider à traduire/localiser Scratch Addons vers ladite langue. Vous pouvez commencer par [rejoindre l’équipe de localisation](/docs/localization/join-the-localization-team).
...
- **Envoyer des commentaires**
  ...
  Vous pouvez envoyer des commentaires [sur cette page](/feedback). Vos commentaires peuvent nous donner une perspective différente dans le développement de l’extension et nous aider à savoir les choses nécessaires attention et corriger les bugs.

- **Laissez un avis sur les boutiques**

  Vous pouvez laisser un commentaire sur Scratch Addons sur [la page d’extension de Chrome](https://chrome.google.com/webstore/detail/fbeffbjdlemaoicjdapfpikkikjoneco), [la page d’ajout de Firefox](https://addons.mozilla.org/firefox/addon/scratch-messaging-extension/) ou [la page d’ajout de Microsoft Edge](https://microsoftedge.microsoft.com/addons/detail/scratch-addons/iliepgjnemckemgnledoipfiilhajdjj). C’est une excellente façon d’aider à convaincre les autres à installer l’extension!
...
- **Passez le mot**
  ...
  Vous pouvez parler de Scratch Addons à n’importe qui, y compris vos amis, vos proches et vos enseignants. Nous vous demandons simplement [de ne pas le faire sur le site Web de Scratch](#can-i-tell-people-about-scratch-addons-on-scratch).
...
- Envoyez-le par [notre formulaire de rétroaction](/feedback).
- Créez un problème sur [le dépôt] (https://github.com/ScratchAddons/ScratchAddons/issues).
- Créez une publication sur [notre onglet Discussion] (https://github.com/ScratchAddons/ScratchAddons/discussions).
- Parlez-nous de [notre serveur Discord] (https://discord.gg/R5NBqwMjNc).

### Je pense que vous avez manqué un article. Que puis-je faire?

Si vous voulez suggérer un addon pour l’extension ou avoir un autre genre de bonne idée, dites-nous avec [une de ces méthodes](#what-can-i-do-if-i-find-a-problem).

### Où puis-je discuter de Scratch Addons?

Vous pouvez le faire sur [notre onglet Discussion](https://github.com/ScratchAddons/ScratchAddons/discussions) ou [notre serveur Discord](https://discord.gg/R5NBqwMjNc). Là, vous pouvez poser des questions et interagir avec la communauté Scratch Addons.
...
Si vous voulez que votre nom figure sur la page, veuillez lire et suivre les instructions de [ce numéro] (https://github.com/ScratchAddons/contributors/issues/{{< specifics/contributors-issue >}}).
