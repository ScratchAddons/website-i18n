...
Scratch-lisäosat on saatavilla näissä kaupoissa.
...
| Kauppa | Asenna | Tuetut selaimet | Järjestelmävaatimukset |
| - | - | - | - |
...
| Firefox Add-ons | [![Asenna Firefox Add-onsista](https://img.shields.io/amo/v/scratch-messaging-extension?style=flat-square&logo=firefox-browser&logoColor=white&label=install&color=FF7139)](https://addons.mozilla.org/firefox/addon/scratch-messaging-extension/) | Mozilla Firefox 109+ | Windows 7+<br />OS X/MacOS 10.12+
...
{{< admonition info >}}
Toisin kuin laajennuskauppojen julkaisut lähdekoodista asentaminen vaatii Chromium 121:tä tai uudempaa taikka Firefox 121:tä tai uudempaa.
{{< /admonition >}}

### Tietosäilön kahdentaminen
