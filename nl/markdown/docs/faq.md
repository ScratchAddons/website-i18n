...
Scratch Addons is een teamproject geleid door World_Languages. De lijst van onze bijdragers kun je vinden in [de Creditspagina](/credits). Hoewel de "Scratch Berichten"- en "Ontwikkelaarstools"-addons origineel gemaakt zijn door griffpatch, onderhoudt hij de extensie niet.
...
Scratch Addons wordt officieel ondersteund op de desktop-versies van [Google Chrome](https://google.com/chrome/) (versie 96 of hoger), [Microsoft Edge](https://www.microsoft.com/en-us/edge) (versie 96 of hoger) en [Mozilla Firefox](https://mozilla.org/firefox/) (versie 109 of hoger) en zou ook moeten werken op andere desktop-browsers die op deze browsers zijn gebaseerd. Bekijk [deze pagina](../getting-started/installing/) voor volledige informatie.
...
- **Feedback geven**
  ...
  Je kunt ons feedback geven [in deze pagina](/feedback). Je feedback kan ons een ander beeld geven in de ontwikkeling van de extensie en laat ons weten over dingen die aandacht of oplossingen nodig hebben.
