...
ส่วนขยายสำหรับ Scratch สามารถใช้ได้อย่างเป็นทางการกับ [Google Chrome](https://google.com/chrome/) สำหรับคอมพิวเตอร์(รุ่นที่ 96 ขึ้นไป), [Microsoft Edge](https://www.microsoft.com/th-th/edge) (รุ่นที่ 96 ขึ้นไป) และ [Mozilla Firefox](https://mozilla.org/firefox/) (รุ่นที่ 109 ขึ้นไป) และสามารถทำงานบนเบราว์เซอร์บนคอมพิวเตอร์อื่นๆที่มีพื้นฐานจากเบราว์เซอร์ข้างต้น กรุณาไปที่[หน้านี้](../getting-started/installing/)สำหรับข้อมูลทั้งหมด
...
แต่มีอีกวิธี ส่วนขยายที่เกี่ยวกับตัวแก้ไขยังใช้งานได้บน [TurboWarp](https://turbowarp.org/) ซึ่งเป็น[แอปที่ดาวน์โหลดได้](https://desktop.turbowarp.org/)สำหรับ Windows, macOS และ Linux และบนเบราเซอร์ที่รองรับ Progressive Web Application (PWA) เช่น Google Chrome คุณยังสามารถติดตั้งตัวแก้ไขของ TurboWarp เป็น PWA แล้วใช้งานโดยไม่ต้องเชื่อมต่ออินเทอร์เน็ต
...
หากคุณพบช่องโหว่ด้านความปลอดภัย โปรดติดต่อ World_Languages เป็นการส่วนตัวโดยส่งอีเมลไปที่ `worldxlanguages (at) gmail.com` หากคุณไม่ได้รับการตอบกลับใน 48 ชั่วโมงกรุณา[สร้าง issue](https://github.com/ScratchAddons/ScratchAddons/issues/) เพื่อบอกว่าคุณส่งอีเมลแล้ว

คุณสามารถ[อ่านนโยบายด้านความปลอดภัยของเรา](https://github.com/ScratchAddons/ScratchAddons/security/policy)หรือ[คำแนะนำด้านความปลอดภัยที่เรามี](https://github.com/ScratchAddons/ScratchAddons/security/advisories?state=published)
