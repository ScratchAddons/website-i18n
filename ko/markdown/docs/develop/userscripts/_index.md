---
title: 사용자 스크립트
description: 사용자 스크립트는 사용자가 스크래치 페이지를 로드할 때마다 실행되는 자바스크립트 파일입니다. 문서의 HTML을 수정하고, 새 버튼을 추가하고, 스크래치 편집기를 사용자 정의하는 등의 작업을 할 수 있습니다.
---

사용자 스크립트는 사용자가 스크래치 페이지를 로드할 때마다 실행되는 자바스크립트 파일입니다. 문서의 HTML을 수정하고, 새 버튼을 추가하고, 스크래치 편집기를 사용자 정의하는 등의 작업을 할 수 있습니다.
