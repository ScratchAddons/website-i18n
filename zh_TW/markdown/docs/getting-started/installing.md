...
| Store | 安裝 | Supported browsers | System requirements |
| - | - | - | - |
...
```
想要更新Scratch Addons, 首先 `cd` 到他的文件夹, 然后输入与启动以下的命令
...
1. 去到[存储库](https://github.com/ScratchAddons/ScratchAddons) 然后找到下载代码的按鈕.
